...
void ASpaceShip::PostEditChangeProperty(FPropertyChangedEvent & PropertyChangedEvent)
{
	...
	UE_LOG(InterstellarLog, Log, TEXT("Post Edit Property Change"));

	switch(PropertyChangedEvent.ChangeType)
	{
		case EPropertyChangeType::Unspecified:
			UE_LOG(InterstellarLog, Log, TEXT("Unspecified"));
			break;

		case EPropertyChangeType::ArrayAdd:

			UE_LOG(InterstellarLog, Log, TEXT("ArrayAdd"));
			break;

		case EPropertyChangeType::ValueSet:

			UE_LOG(InterstellarLog, Log, TEXT("ValueSet"));
			break;

		case EPropertyChangeType::Duplicate:

			UE_LOG(InterstellarLog, Log, TEXT("Duplicate"));
			break;

		case EPropertyChangeType::Interactive:

			UE_LOG(InterstellarLog, Log, TEXT("Interactive"));
			break;

		case EPropertyChangeType::Redirected:

			UE_LOG(InterstellarLog, Log, TEXT("Redirected"));
			break;
	}

	//PropertyChangedEvent.Property->GetClass();

	UE_LOG(InterstellarLog, Log, TEXT("String %s"), *PropertyChangedEvent.GetPropertyName().ToString());
