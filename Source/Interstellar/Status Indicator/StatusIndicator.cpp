...
void UStatusIndicator::RadialCCWSyncFunction()
{
	...
	{
		//UE_LOG(InterstellarLog, Log, TEXT("%s"), *Style.SwipeMaterial.GetResourceName().ToString());
	...
	else
	{
		...
		//UE_LOG(InterstellarLog, Log, TEXT("Results found: %d"), assetArray.Num());
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_CounterClockwiseRadialFill"));
...
void UStatusIndicator::LeftToRightSyncFunction()
{
	...
	else
	{
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_LeftToRightFill"));
				auto  asset = assetData.GetAsset();
				Style.SwipeMaterial.SetResourceObject(asset);
				Style.SwipeMaterial.TintColor = FLinearColor::White;
			}
...
void UStatusIndicator::RightToLeftSyncFunction()
{
	...
	else
	{
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_RightToLeftFill"));
				auto  asset = assetData.GetAsset();
				Style.SwipeMaterial.SetResourceObject(asset);
				Style.SwipeMaterial.TintColor = FLinearColor::White;
			}
...
void UStatusIndicator::BottomToTopSyncFunction()
{
	...
	else
	{
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_BottomToTopFill"));
				auto  asset = assetData.GetAsset();
				Style.SwipeMaterial.SetResourceObject(asset);
				Style.SwipeMaterial.TintColor = FLinearColor::White;
			}
...
void UStatusIndicator::TopToBottomSyncFunction()
{
	...
	else
	{
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_TopToBottomFill"));
				auto  asset = assetData.GetAsset();
				Style.SwipeMaterial.SetResourceObject(asset);
				Style.SwipeMaterial.TintColor = FLinearColor::White;
			}
...
void UStatusIndicator::BottomLeftToTopRightSyncFunction()
{
	...
	else
	{
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_BottomLeftToTopRightFill"));
				auto  asset = assetData.GetAsset();
				Style.SwipeMaterial.SetResourceObject(asset);
				Style.SwipeMaterial.TintColor = FLinearColor::White;
			}
...
{	
	...
	else
	{
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_BottomRightToTopLeftFill"));
				auto  asset = assetData.GetAsset();
				Style.SwipeMaterial.SetResourceObject(asset);
				Style.SwipeMaterial.TintColor = FLinearColor::White;
			}
...
void UStatusIndicator::TopRightToBottomLeftSyncFunction()
{
	...
	else
	{
		...
		for (auto& assetData : assetArray)
		{
			...
			{
				UE_LOG(InterstellarLog, Log, TEXT("Found M_TopRightToBottomLeftFill"));
				auto  asset = assetData.GetAsset();
				Style.SwipeMaterial.SetResourceObject(asset);
				Style.SwipeMaterial.TintColor = FLinearColor::White;
			}
...
void UStatusIndicator::FindAndSetDefaultTextures()
{
	...
	for (auto& assetData : assetArray)
	{
		...
		{
			UE_LOG(InterstellarLog, Log, TEXT("Found shield_status_icon"));
		...
		{
			UE_LOG(InterstellarLog, Log, TEXT("Found shield_status_icon_fill"));
			auto object = assetData.GetAsset();
			auto texture = Cast<UTexture2D>(object);
